...
my_data <- load_and_inspect("C:/Users/roomg/OneDrive/Рабочий стол/AB_NYC_2019.csv")
...
cheap_manhattan <- filter_by_area_and_price(my_data, "Manhattan", 100)
...
generate_report(my_data, "Manhattan")
generate_report(my_data, "Brooklyn")
